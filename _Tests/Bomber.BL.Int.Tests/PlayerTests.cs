...
namespace Bomber.BL.Int.Tests
{
    public class PlayerTests : ABomberTest
    {
            ...
            IBoardService boardService)
        {
            ...
            {
                _ = new PlayerModel(view, position, name, email, Mock.Of<IGameManager>(), Mock.Of<ILifeCycleManager>(), boardService);
            });
        ...
        {
            var player = new PlayerModel(Mock.Of<IPlayerView>(), Mock.Of<IPosition2D>(),  "Some Name", "email", Mock.Of<IGameManager>(), Mock.Of<ILifeCycleManager>(), Mock.Of<IBoardService>());
        ...
        public void BT_0121_Given_Player_When_ViewLoaded_Then_TheViewIsUpdated()
        {
            ...
            _ = new PlayerModel(viewMock.Object, PositionFactory.CreatePosition(0, 0),  "Some Name", "email", Mock.Of<IGameManager>(), Mock.Of<ILifeCycleManager>(), Mock.Of<IBoardService>());
